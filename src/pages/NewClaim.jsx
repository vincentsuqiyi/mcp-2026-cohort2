      ...
      <section className="p-6 md:p-gutter max-w-container-max-width mx-auto w-full space-y-gutter">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-outline-variant gap-4">
          ...
          <div className="flex w-full md:w-auto gap-4">
            <button className="flex-1 md:px-12 py-3 rounded-xl bg-secondary text-on-secondary font-label-md text-label-md flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
              Continue to Details
